...
12. **Checkpoint:** Run `docker network ls`. Does the list of networks contain one named `docker_gwbridge`? The networks should match the following (except the generated NETWORK ID):
	```[~] # docker network ls
